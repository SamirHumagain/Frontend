...
const AddVenueModal: React.FC<Props> = ({ isOpen, onClose, onSubmit, setters, values }) => {
	const {
		setVenueName,
		setDescription,
		setPrice,
	...
	const { venueName, description, price, eventType, selectedImageUrl, imageUrl, selectedPosition, currentPosition } = values;
			...
			>
				...
				>
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div>
							<label className="block text-sm font-medium text-gray-700 mb-2">Venue Image File (optional)</label>
							<input
								type="file"
								accept="image/*"
								className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
					...
					<div>
						<label className="block text-sm font-medium text-gray-700 mb-2">Image URL (preferred)</label>
						<input
							type="url"
							className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none"
